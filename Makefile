...
INC = 
CFLAGS = -Weffc++ -Wall -fvisibility=hidden
RESINC = 
LIBDIR = 
LIB = 
LDFLAGS = 
...
INC_LIB_DEBUG = $(INC)
CFLAGS_LIB_DEBUG = $(CFLAGS) -Og -g
RESINC_LIB_DEBUG = $(RESINC)
RCFLAGS_LIB_DEBUG = $(RCFLAGS)
LIBDIR_LIB_DEBUG = $(LIBDIR)
LIB_LIB_DEBUG = $(LIB)
LDFLAGS_LIB_DEBUG = $(LDFLAGS)
OBJDIR_LIB_DEBUG = obj\\Lib_Debug
DEP_LIB_DEBUG = 
OUT_LIB_DEBUG = bin\\Lib_Debug\\libcreq.dll

INC_LIB_RELEASE = $(INC)
CFLAGS_LIB_RELEASE = $(CFLAGS) -O2
RESINC_LIB_RELEASE = $(RESINC)
RCFLAGS_LIB_RELEASE = $(RCFLAGS)
LIBDIR_LIB_RELEASE = $(LIBDIR)
LIB_LIB_RELEASE = $(LIB)
LDFLAGS_LIB_RELEASE = $(LDFLAGS) -s
OBJDIR_LIB_RELEASE = obj\\Lib_Release
DEP_LIB_RELEASE = 
OUT_LIB_RELEASE = bin\\Lib_Release\\libcreq.dll

INC_LIB_FULLYOPTIMIZED = $(INC)
CFLAGS_LIB_FULLYOPTIMIZED = $(CFLAGS) -fomit-frame-pointer -fexpensive-optimizations -flto -O3
...
LDFLAGS_LIB_FULLYOPTIMIZED = $(LDFLAGS) -flto -s
OBJDIR_LIB_FULLYOPTIMIZED = obj\\Lib_FullyOptimized
DEP_LIB_FULLYOPTIMIZED = 
OUT_LIB_FULLYOPTIMIZED = bin\\Lib_FullyOptimized\\libcreq.dll

INC_TEST_DEBUG = $(INC)
CFLAGS_TEST_DEBUG = $(CFLAGS) -Og -g
...
DEP_TEST_DEBUG = 
OUT_TEST_DEBUG = bin\\Test_Debug\\creq_test.exe
...
before_lib_debug: 
	cmd /c if not exist bin\\Lib_Debug md bin\\Lib_Debug
	cmd /c if not exist $(OBJDIR_LIB_DEBUG) md $(OBJDIR_LIB_DEBUG)
...
clean_lib_debug: 
	cmd /c del /f $(OBJ_LIB_DEBUG) $(OUT_LIB_DEBUG)
	cmd /c rd bin\\Lib_Debug
	cmd /c rd $(OBJDIR_LIB_DEBUG)

before_lib_release: 
	cmd /c if not exist bin\\Lib_Release md bin\\Lib_Release
	cmd /c if not exist $(OBJDIR_LIB_RELEASE) md $(OBJDIR_LIB_RELEASE)
...
clean_lib_release: 
	cmd /c del /f $(OBJ_LIB_RELEASE) $(OUT_LIB_RELEASE)
	cmd /c rd bin\\Lib_Release
	cmd /c rd $(OBJDIR_LIB_RELEASE)

before_lib_fullyoptimized: 
	cmd /c if not exist bin\\Lib_FullyOptimized md bin\\Lib_FullyOptimized
	cmd /c if not exist $(OBJDIR_LIB_FULLYOPTIMIZED) md $(OBJDIR_LIB_FULLYOPTIMIZED)
...
clean_lib_fullyoptimized: 
	cmd /c del /f $(OBJ_LIB_FULLYOPTIMIZED) $(OUT_LIB_FULLYOPTIMIZED)
	cmd /c rd bin\\Lib_FullyOptimized
	cmd /c rd $(OBJDIR_LIB_FULLYOPTIMIZED)

before_test_debug: 
	cmd /c if not exist bin\\Test_Debug md bin\\Test_Debug
	cmd /c if not exist $(OBJDIR_TEST_DEBUG) md $(OBJDIR_TEST_DEBUG)
...
clean_test_debug: 
	cmd /c del /f $(OBJ_TEST_DEBUG) $(OUT_TEST_DEBUG)
	cmd /c rd bin\\Test_Debug
	cmd /c rd $(OBJDIR_TEST_DEBUG)
